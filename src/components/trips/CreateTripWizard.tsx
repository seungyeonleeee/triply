...
export default function CreateTripWizard({ variant = "button" }: CreateTripWizardProps) {
  ...
  const companionOptions = ["혼자", "친구와", "연인과", "배우자와", "아이와", "부모님과"];
  ...
  const handleCreate = () => {
    ...
    addTrip({
      ...
      companions: companionType === "혼자" ? [] : companions,
      travelStyle: styles.length > 0 ? (styles[0] as TravelStyle) : undefined,
